...
// prefixed operator
let a = 10;
console.log(`Initial assigment: ${a}`);
console.log(`Posfix ++: ${a++}`); // The ++ executes after the console.log
console.log(`Re read the variable: ${a}`);
console.log(`Prefix ++: ${++a}`); // The ++ executes before the console.log

//3. Calculate the sum of the deposits and the withdrawls
...
//4. Covert a string to title case
...
const convertTitleCase = function (title) {
  ...
  // Convert the first letter of the phrase
...
convertTitleCase('Covert a string to title case');
...
dogs.forEach(function (dog) {
  if (dog.owners.includes('Sarah')) {
    if (
      ...
      console.log("Sarah's dog is not eating the recommended amount of food");
  }
});
